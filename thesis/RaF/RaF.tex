...
\begin{table}[ht]
	...
	\label{tab:testing}
	\begin{tabular}{|p{1cm}|p{3.6cm}|p{4.9cm}|p{2cm}|p{2.5cm}|}
		\hline
		\textbf{Test} & \textbf{Description} & \textbf{Expected Outcome} & \textbf{Functions Checked} & \textbf{Requirements Tested} \\ \hline
